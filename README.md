...
2. Download [86ME](https://github.com/Sayter99/86ME/releases/download/86ME/86ME_v1.3.zip).
3. Unzip 86ME and execute 86ME.exe to start.

**The [86ME tutorial page](http://www.86duino.com/index.php?p=11544&lang=TW) for installation instructions and usage.**
